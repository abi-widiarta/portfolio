...
export const Contact = () => {
  return (
    <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25, ease: "easeOut" }} className="p-5 pb-52">
      ...
      <div className="w-full p-5 mt-8 border border-gray-200 rounded-lg">
        <div className="flex items-end space-x-2">
          <img className="dark:invert" src="/icon-contact.svg" alt="" />
        ...
        <a className="block px-4 py-3 mt-8 transition rounded-lg dark:bg-slate-700 hover:opacity-70 w-fit bg-slate-200" href="https://mail.google.com/mail/?view=cm&fs=1&to=abiwidiarta01@gmail.com">
          Contact Me
        </a>
      </div>
      ...
      <p className="mt-1 text-gray-600 text-md dark:text-slate-300">Find me on social media</p>
      <div className="flex mt-6 space-x-6">
        ...
        <a href="https://github.com/abi-widiarta">
          <img className="w-8 dark:invert" src="/icon-github.svg" alt="" />
        </a>
      </div>
    </motion.div>
  );
